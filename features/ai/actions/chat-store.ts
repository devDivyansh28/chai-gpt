...
function toUIMessageParts(parts : Prisma.JsonValue | null,
    content : string
) : UIMessage["parts"]{
...
export async function saveChatMessages(
    ...
    const firstUserText = firstUser ? getMessageText(firstUser) : "";
    ...
    await prisma.conversation.update({
        ...
        data : {
            ...
            title : 
            updateTitle && conversation.title === "New Chat" && firstUserText ? firstUserText.slice(0,48) : conversation.title,
        }
    })
